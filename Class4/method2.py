...
#%% Read, map and pivot data in 1 day
...
def main_task():
    ...
    #
    print('-----------Saving Data ---------')
    result1.repartition(1).write.csv('/Users/habaokhanh/Study_BigData_Dataset/log_content/df_clean2',header=True)
